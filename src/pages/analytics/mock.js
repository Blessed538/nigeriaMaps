...
function getRevenueData() {
  const data = [];
  const seriesCount = 3;
  const accessories = ['Submisions', 'Pending Submissions', 'Pending Publishing'];
